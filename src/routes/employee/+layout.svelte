...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-side">
      ...
      <ul class="menu bg-base-200 text-base-content min-h-full w-80 p-4">
        <li><a href="/employee/events"class="btn btn-ghost">Events</a></li>
        <li><a href="/employee/equipment"class="btn btn-ghost">Equipments</a></li>
        <li><a href="/employee/employees" class="btn btn-ghost">Employees</a></li>
        <li><a href="/employee/services" class="btn btn-ghost">Services</a></li>
